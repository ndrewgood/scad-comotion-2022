...
var one$3 = zwitch('type');
one$3.handlers.root = root$2;
one$3.handlers.element = element;
one$3.handlers.text = text$2;
one$3.handlers.comment = comment;
one$3.handlers.doctype = doctype; // Transform a tree from hast to Parse5’s AST.

function transform(tree, space) {
  return one$3(tree, space === 'svg' ? svg_1$1 : html_1$2);
}
